...
describe("formatToDuatCode", () => {
  it("should take takes a 'aa' and return 'aa'", () => {
    expect(TextFormatter.formatToDuatCode("a", "a")).toBe("aa")
  })
  it("should take takes a 'aag' and return 'aa/g", () => {
    expect(TextFormatter.formatToDuatCode("aag", "")).toBe("aa/g")
  })
  it("should take takes a 'aargty' and return 'aa/rgty'", () => {
    expect(TextFormatter.formatToDuatCode("aargty", "")).toBe("aa/rgty")
  })
})
